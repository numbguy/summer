...
<h1><font face="Palatino Linotype, Book Antiqua, Palatino, serif" color="#007FFF"> Pencil Paintings </font></h1>
<div class="row">
<?php
	require('mysqli_conn.php');
	$image_path = 'http://localhost:97/recon/admin/photos/';
	$q = "SELECT ImageId,image_name ,image_category FROM pencil";
  ...
  <div class="col-xs-3">
   ...
   <!--    <a href="product_show.php?id='.$row['ImageId'].'">-->
	<a href="product_show.php?imagename='.$row['image_name'].' AND imagecategory = '.$row['image_category'].'">
